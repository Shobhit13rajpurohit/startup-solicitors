  ...
  return (
    <header className="">
      <div className="container mx-auto px-4">
        {/* Top section: Only Search bar on the right now */}
        ...
        {/* Navigation - Logo is now part of the NavigationMenuList */}
        <nav className="border-b border-blue-400">
          <ul className="flex space-x-8 py-4 items-center w-full max-w-none">
            ...
            {/* Individual Menu Item (Manual Implementation) */}
            <li
              className="relative" // Important for positioning the dropdown
              ...
              {isIndividualMenuOpen && (
                <div
                  className="absolute top-full left-1/2 -translate-x-1/2 mt-1.5
                             bg-[#0073aa]/80 backdrop-blur-md border border-gray-200 shadow-lg rounded-md // Glassy effect classes
                             min-w-max z-20
                             p-4 space-y-2"
                >
                  <Link
            ...
            {/* Business Menu Item (Apply similar manual implementation) */}
            <li
              className="relative"
            ...
            >
              ...
              {isBusinessMenuOpen && (
                <div
                  className="absolute top-full left-1/2 -translate-x-1/2 mt-1.5
                             bg-[#0073aa]/80 backdrop-blur-md border border-gray-200 shadow-lg rounded-md // Glassy effect classes
                             min-w-max max-h-96 overflow-y-auto z-20
                             p-4 space-y-2"
                >
                  <Link
                  ...
                  <Link
                    href="/business/cross-border-services"
                    className="block px-3 py-2 hover:bg-blue-600 rounded text-white"
                  >
                    Cross-Border Services in India
                  </Link>
                  <Link
                    href="/business/crypto-investment-advisory-services"
                    className="block px-3 py-2 hover:bg-blue-600 rounded text-white"
                  >
                    Crypto Investment Advisory Services in India
                  </Link>
                  <Link
                    href="/business/file-tax-returns"
                    className="block px-3 py-2 hover:bg-blue-600 rounded text-white"
                  >
                    File Tax Returns
                  </Link>
                  ...
                  <Link
                    href="/business/investment-advisory-services"
                    className="block px-3 py-2 hover:bg-blue-600 rounded text-white"
                  >
                    Investment Advisory Services in India
                  </Link>
                  <Link
                    href="/business/legal-services"
                    className="block px-3 py-2 hover:bg-blue-600 rounded text-white"
                  >
                    Legal Services in India
                  </Link>
                  <Link
                    href="/business/regulatory-approvals-compliance"
                    className="block px-3 py-2 hover:bg-blue-600 rounded text-white"
                  >
                    Regulatory Approvals & Compliance Services in India
                  </Link>
                  <Link
                  ...
                  <Link
                    href="/business/startup-business-advisory"
                    className="block px-3 py-2 hover:bg-blue-600 rounded text-white"
                  >
                    Startup and Business Advisory Services in India
                  </Link>
                  <Link
                    href="/business/virtual-cfo-services"
                    className="block px-3 py-2 hover:bg-blue-600 rounded text-white"
                  >
                    Virtual CFO Services in India
                  </Link>
                  <Link
                    href="/business/white-collar-crimes"
                    className="block px-3 py-2 hover:bg-blue-600 rounded text-white"
                  >
                    White Collar Crimes
                  </Link>
            ...
            <li>
              <Link
                href="/blogs"
                className={`border-l border-blue-400 text-blue-600 px-3 py-2  ${
                  activeTab === "blogs" ? "bg-blue-50" : ""
                }`}
              >
                Blogs
              </Link>
            ...
            {/* About Menu Item (Apply similar manual implementation) */}
            <li
              className="relative"
            ...
            >
              ...
              {isAboutMenuOpen && (
                ...
                >
                  <Link
                    href="/our-team"
                    className="block px-3 py-2 hover:bg-blue-600 rounded text-white" // text-white for links inside glassy menu
                  >
                    our team
                  </Link>
            ...
            {/* Business Setup-India Link */}
            <li>
              <Link
                href="/business-setup-india"
                className={`border-l border-blue-400 text-blue-600 px-3 py-2  ${
                  activeTab === "business-setup-india" ? "bg-blue-50" : ""
                }`}
              >
