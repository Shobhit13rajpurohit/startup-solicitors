...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ref={ref}
    className={cn(
      "absolute top-0 left-0 w-[var(--radix-navigation-menu-viewport-width)] min-w-[200px] p-2 data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out data-[motion=from-end]:slide-in-from-right-52 data-[motion=from-start]:slide-in-from-left-52 data-[motion=to-end]:slide-out-to-right-52 data-[motion=to-start]:slide-out-to-left-52",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div className={cn("absolute top-full flex")}>
    <NavigationMenuPrimitive.Viewport
      ...
      {...props}
      style={{
        transform: 'translateX(var(--radix-navigation-menu-viewport-transform-x))',
      }}
    />
  </div>
))
